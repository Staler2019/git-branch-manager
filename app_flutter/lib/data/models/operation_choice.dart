...
enum OperationChoiceKind { stashAndRetry, forceDiscard, abort, retry, removeLock }
...
class OperationChoice {
  const OperationChoice({required this.kind, required this.label, required this.explanation, required this.destructive});
  ...
  static List<OperationChoice> listFromJson(List<dynamic> json) =>
      json.map((e) => OperationChoice.fromJson(e as Map<String, dynamic>)).toList(growable: false);
