...
/// **This file was deleted once, as orphan wiring, and restored on the
/// user's ruling (2026-08-26).** C13 grepped every reader, found the only
/// occurrence of 「side-by-side」 anywhere in the spec was a fake commit
/// message inside a mockup, and deleted this file and its view with their
/// tests. That reading of the spec was correct and still is -- the spec does
/// not ask for this -- but the user has since ruled side-by-side into
/// History's commit detail, so「no spec basis」is no longer a reason to
/// delete it. `docs/reports/spec-conformance-matrix.md` has been corrected in
/// place rather than left to contradict this comment; an orphan sweep that
/// reaches this file should read that row before acting.
///
