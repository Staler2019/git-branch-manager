...
enum GbmGraphColumnId {
  ...
  /// Spec's "Graph 與 Message 固定不可關". Mirrors
  /// [kLockedGraphColumnIds], which is the same rule enforced one layer
  /// down at the store -- a disabled checkbox is an affordance, not an
  /// invariant.
  bool get isLocked => kLockedGraphColumnIds.contains(storageId);
