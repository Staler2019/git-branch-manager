...
void main() {
  group('gbmMenus', () {
    test('all 51 GbmActionId values appear exactly once across all menus', () {
      ...
      // Check completeness: all 51 IDs should be in the set
      expect(
        idSet,
        GbmActionId.values.toSet(),
        reason: 'All 51 GbmActionId values must be present',
      );
    });
    ...
    test('only viewGraphColumns and viewTheme have isSubmenuParent=true', () {
      ...
      expect(
        ...
        49,
        reason: '49 items should not be submenu parents',
      );
    });
    ...
    test('only branchDeleteBranch has isDanger=true', () {
      ...
      expect(
        ...
        50,
        reason: '50 items should not be marked as danger',
      );
    });
  });
}
